...
import { BriefcaseIcon, LinkedinIcon, FacebookIcon, MailIcon, PhoneIcon } from './ui/icons';
            ...
            <div className="lg:col-span-4">
                ...
                <div className="mt-6 space-y-3">
                 ...
                 <div className="mt-6 flex space-x-4">
                    ...
                    <a href="https://facebook.com/primetemp" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-primary"><span className="sr-only">Facebook</span><FacebookIcon className="h-6 w-6" /></a>
                </div>
            </div>
