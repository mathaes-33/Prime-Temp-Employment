...
const JOB_CATEGORIES: JobCategory[] = ['Technology', 'Design', 'Administrative', 'Management', 'Marketing', 'Finance', 'Healthcare'];
...
const JobForm: React.FC<JobFormProps> = ({ job = NEW_JOB_TEMPLATE, onSubmit, onCancel }) => {
